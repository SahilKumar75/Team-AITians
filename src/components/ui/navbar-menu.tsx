          ...
          {active === item && (
            <div className="absolute top-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 pt-4">
              <motion.div
                ...
                className="bg-white dark:bg-neutral-800 backdrop-blur-sm rounded-lg overflow-hidden border border-neutral-200 dark:border-neutral-700 shadow-xl"
              >
                <motion.div
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="flex justify-center items-center gap-1.5 lg:gap-2 whitespace-nowrap"
    >
      {children}
    </nav>
  );
